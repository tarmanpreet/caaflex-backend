    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                <p>
                    Quando l’autenticazione a due fattori è attiva, durante l’accesso ti verrà richiesto un codice sicuro e casuale, disponibile nell’app Google Authenticator sul telefono.
                </p>
            </div>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p v-if="confirming" class="font-semibold">
                            Per completare l’attivazione, scansiona il seguente codice QR con l’app di autenticazione oppure inserisci la chiave di configurazione e il codice OTP generato.
                        </p>

                        <p v-else>
                            L’autenticazione a due fattori è ora attiva. Scansiona il codice QR con l’app di autenticazione oppure inserisci la chiave di configurazione.
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p class="font-semibold">
                            Conserva questi codici di recupero in un gestore di password sicuro. Potrai usarli per recuperare l’accesso se perdi il dispositivo per l’autenticazione a due fattori.
                        </p>
                    </div>
