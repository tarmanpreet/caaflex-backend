...
const form = useForm({
    ...
    duration_minutes: props.type.duration_minutes,
...
const submitForm = () => {
    form.put(route('practice-types.update', props.type.id));
};
</script>

<template>
    <AppLayout title="Modifica Tipo Pratica">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Modifica Tipo Pratica</h2>
        </template>
