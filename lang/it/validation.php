...
return [
    ...
    */
    ...
    'digits' => 'Il campo :attribute deve essere numerico e lungo :digits cifre.',
    'digits_between' => 'Il campo :attribute deve essere numerico e lungo tra :min e :max cifre.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Il :attribute indicato è presente in una perdita di dati. Scegli un :attribute diverso.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'type' => 'tipo',
        'client_profile_id' => 'cliente',
        'procedure_id' => 'procedura',
        'procedure_type_id' => 'tipo di procedura',
        'reference_year' => 'anno di riferimento',
        'deadline_at' => 'scadenza',
        'deadline_days' => 'giorni di preavviso',
        'deadline_templates' => 'template di scadenza',
        'default_notes' => 'note predefinite',
        'generate_procedure_steps' => 'genera step della procedura',
        'priority' => 'priorità',
        'user_ids' => 'utenti',
        'assigned_user_id' => 'utente assegnato',
        'user_id' => 'utente',
        'practice_id' => 'pratica',
        'practice_type_id' => 'tipo di pratica',
        'practice_type_ids' => 'tipi di pratica',
        'scheduled_at' => 'data e ora',
